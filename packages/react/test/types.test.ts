...
import { type DOMSink, type VNode, isolate } from "effect-cycle-react"
...
describe("VNode (react) type", () => {
  it("aliases react's ReactElement", () => {
    expectTypeOf<VNode>().toEqualTypeOf<ReactElement>()
  })
})
